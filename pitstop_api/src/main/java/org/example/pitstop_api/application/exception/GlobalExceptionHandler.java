...
import org.example.pitstop_api.application.exception.util.ErrorResponse;
import org.example.pitstop_api.application.exception.util.PathInterceptor;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDadoUnicoDuplicadoException(DadoUnicoDuplicadoException ex) {
        String path = pathInterceptor.getPath();
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.CONFLICT, ex.getMessage(), path);
    ...
    public ResponseEntity<ErrorResponse> handleSenhaIncorretaException(SenhaIncorretaException ex) {
        String path = pathInterceptor.getPath();
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.UNAUTHORIZED, ex.getMessage(), path);
    ...
    public ResponseEntity<ErrorResponse> handleSQLException(SQLException ex) {
        String path = pathInterceptor.getPath();
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage(), path);
    ...
    public ResponseEntity<ErrorResponse> handleSenhaNulaOuVaziaException(SenhaNulaOuVaziaException ex) {
        String path = pathInterceptor.getPath();
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.FORBIDDEN, ex.getMessage(), path);
    ...
    public ResponseEntity<ErrorResponse> handleNotImplementedException(NotImplementedException ex) {
        String path = pathInterceptor.getPath();
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.NOT_IMPLEMENTED, ex.getMessage(), path);
